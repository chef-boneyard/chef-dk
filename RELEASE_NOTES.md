...
Chef InSpec has been updated to 4.7.3, which adds a new `ip6tables` resource and includes new aws-sdk gems necessary for the Chef InSpec AWS Resource Pack.
